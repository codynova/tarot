...
const pluginLintScripts = (eslintConfigPath, source) => new PluginESLint({ context: source, fix: true, configFile: eslintConfigPath });
...
const generateConfig = ({
    ...
    plugins: [
        ...
        useLinting ? pluginLintScripts(eslintConfigPath, source) : () => {},
