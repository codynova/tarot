...
const pluginForkTypeScriptCheck = (eslintConfigPath, tsConfigPath) => new PluginForkTypeScriptCheck({ eslint: true, eslintOptions: { configFile: eslintConfigPath, fix: true }, tsconfig: tsConfigPath });
...
const generateConfig = ({
    ...
    plugins: [
        ...
        pluginForkTypeScriptCheck(eslintConfigPath, tsConfigPath),
