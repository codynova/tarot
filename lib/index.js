...
const pluginLintScripts = (source, eslintConfigPath, eslintIgnorePath, eslintExcludes) => new PluginESLint({ context: source, cwd: source, configFile: eslintConfigPath, ignorePath: eslintIgnorePath, ignorePattern: eslintExcludes });
